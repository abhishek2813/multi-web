  ...
  return (
    <div className='bg-image p-5' id='currency'>
      ...
      <Row className='shadow-lg p-3 mb-5 bg-white rounded'>
        <Col md={5}>
            <Input label="From" amount={amount} currencyOptions={options} onCurrencyChange={(curr)=>setFrom(curr)}
        ...
        <Col md={5}>
        <Input amount={convertAmount} label="To" currencyOptions={options} selectCurrency={to} onCurrencyChange={(currency) => setTo(currency)}
        amountDisable
        />
        </Col>
